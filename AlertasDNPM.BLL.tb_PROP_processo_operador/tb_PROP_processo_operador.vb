Public Class tb_PROP_processo_operador
    ...
    Public Function InsertData(ByVal dto As DTO.tb_PROP_processo_operador) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_PROP_processo_operador(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_PROP_processo_operador) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_PROP_processo_operador) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_PROP_processo_operador) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_PROP_processo_operador) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_PROP_processo_operador) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_PROP_processo_operador, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "PROP")
        ...
        If mode = tb_PROP_processo_operador.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_PROP_processo_operador) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "validate")
        Dim dtFields As DataTable = obj.getFormData(_xmlPath, "PROP")


fim:
        Return ret
    End Function
    Public Function SaveData(ByVal dto As DTO.tb_PROP_processo_operador, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_PROP_processo_operador.Mode.Insert
                        Return InsertData(dto)
                    Case tb_PROP_processo_operador.Mode.Update
