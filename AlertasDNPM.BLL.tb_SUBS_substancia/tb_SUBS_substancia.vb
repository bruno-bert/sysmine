Public Class tb_SUBS_substancia
    ...
    Public Function InsertData(ByVal dto As DTO.tb_SUBS_substancia) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_SUBS_substancia(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_SUBS_substancia) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_SUBS_substancia) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_SUBS_substancia) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_SUBS_substancia) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_SUBS_substancia) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_SUBS_substancia, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "SUBS")
        ...
        If mode = tb_SUBS_substancia.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_SUBS_substancia) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "SUBS")
...
fim:
    ...
    Public Function SaveData(ByVal dto As DTO.tb_SUBS_substancia, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_SUBS_substancia.Mode.Insert
                        Return InsertData(dto)
                    Case tb_SUBS_substancia.Mode.Update
