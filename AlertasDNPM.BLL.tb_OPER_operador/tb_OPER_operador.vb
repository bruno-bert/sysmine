Public Class tb_OPER_operador
    ...
    Public Function InsertData(ByVal dto As DTO.tb_OPER_operador) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_OPER_operador(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_OPER_operador) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_OPER_operador) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_OPER_operador) As DataTable
    ...
    End Function
    Public Function GetNextIndex(ByVal dto As DTO.tb_OPER_operador) As Long
        ...
        Dim field As String = "OPER_cd_operador"
        Dim dal As New DAL.tb_OPER_operador(ConnectionString, dto)
    ...
    End Function
    Public Function ConsultData(ByVal dto As DTO.tb_OPER_operador) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_OPER_operador) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_OPER_operador, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "OPER")

        ret = obj.ValidateString(fields.getValue(dt, "OPER_cd_operador"), dto.OPER_cd_operador, False, base._strPadrao, 20, True, getAllowedValues("OPER_cd_operador"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "OPER_nm_operador"), dto.OPER_nm_operador, False, base._strPadrao, 1000, True, getAllowedValues("OPER_nm_operador"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "OPER_ds_email"), dto.OPER_ds_email, False, base._strPadrao, 200, True, getAllowedValues("OPER_ds_email"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "OPER_fl_alerta"), dto.OPER_fl_alerta, False, base._strPadrao, 1, True, getAllowedValues("OPER_fl_alerta"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "OPER_fl_alerta_nativo"), dto.OPER_fl_alerta_nativo, False, base._strPadrao, 1, True, getAllowedValues("OPER_fl_alerta_nativo"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        If mode = tb_OPER_operador.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_OPER_operador) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "validate")
        Dim dtFields As DataTable = obj.getFormData(_xmlPath, "OPER")

        'valida formato email
        If Not val.is_valid_email(dto.OPER_ds_email) Then
            ret = obj.getValue(dtFields, "OPER_ds_email") & ": " & obj.getValue(dt, "format")
            GoTo fim
        End If
...
fim:
        Return ret
    End Function
    Public Function SaveData(ByVal dto As DTO.tb_OPER_operador, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_OPER_operador.Mode.Insert
                        Return InsertData(dto)
                    Case tb_OPER_operador.Mode.Update
        ...
        Return False
    End Function
    Private Function getAllowedValues(ByVal field As String) As String
        Dim values As String = ""
        Dim delimallowed As String = "|"

        'select case field
        'Case OPER_cd_operador
        'values = ""

        'Case OPER_nm_operador
        'values = ""
