Public Class tb_SISD_situacao_sd
   ...
   Public Function GetNextIndex(ByVal dto As DTO.tb_SISD_situacao_sd, field as String) As Long
        ...
        Dim dal As New DAL.tb_SISD_situacao_sd(ConnectionString, dto)
    ...
    Public Function InsertData(ByVal dto As DTO.tb_SISD_situacao_sd) As Boolean
    ...
    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_SISD_situacao_sd) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_SISD_situacao_sd) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_SISD_situacao_sd) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_SISD_situacao_sd) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_SISD_situacao_sd) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_SISD_situacao_sd, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "SISD")
...
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.SISD_nm_situacao_sd, False, base._strPadrao, 100, True, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

If mode = tb_SISD_situacao_sd.Mode.Insert Then 
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function customValidation(ByVal dto As DTO.tb_SISD_situacao_sd) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "SISD")
    ...
    Public Function SaveData(ByVal dto As DTO.tb_SISD_situacao_sd, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
             Select Case mode
                Case tb_SISD_situacao_sd.Mode.Insert
                    Return InsertData(dto)
                Case tb_SISD_situacao_sd.Mode.Update
