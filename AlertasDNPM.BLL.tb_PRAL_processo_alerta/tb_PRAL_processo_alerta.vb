Public Class tb_PRAL_processo_alerta
    ...
    Public Function InsertData(ByVal dto As DTO.tb_PRAL_processo_alerta) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_PRAL_processo_alerta(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_PRAL_processo_alerta) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_PRAL_processo_alerta) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_PRAL_processo_alerta) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_PRAL_processo_alerta) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_PRAL_processo_alerta) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_PRAL_processo_alerta, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "PRAL")
        ...
        If mode = tb_PRAL_processo_alerta.Mode.Insert Then
            ret = obj.ValidateString(fields.getValue(dt, "PRAL_fl_manutencao"), dto.PRAL_fl_manutencao, False, base._strPadrao, 1, True, getAllowedValues("PRAL_fl_manutencao"), forceInvalidation, addFieldNameToMessage)
            If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_PRAL_processo_alerta) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "validate")
        Dim dtFields As DataTable = obj.getFormData(_xmlPath, "PRAL")
...
fim:
    ...
    Public Function SaveData(ByVal dto As DTO.tb_PRAL_processo_alerta, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_PRAL_processo_alerta.Mode.Insert
                        Return InsertData(dto)
                    Case tb_PRAL_processo_alerta.Mode.Update
