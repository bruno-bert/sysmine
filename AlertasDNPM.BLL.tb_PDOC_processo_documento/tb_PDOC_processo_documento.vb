Public Class tb_PDOC_processo_documento
    ...
    Public Function InsertData(ByVal dto As DTO.tb_PDOC_processo_documento) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_PDOC_processo_documento(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_PDOC_processo_documento) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_PDOC_processo_documento) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_PDOC_processo_documento) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_PDOC_processo_documento) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_PDOC_processo_documento) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_PDOC_processo_documento, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "PDOC")
        ...
        ret = obj.ValidateString(fields.getValue(dt, "PDOC_nm_documento"), dto.PDOC_nm_documento, False, base._strPadrao, 100, True, getAllowedValues("PDOC_nm_documento"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "PDOC_ds_documento"), dto.PDOC_ds_documento, False, base._strPadrao, 100, False, getAllowedValues("PDOC_ds_documento"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "PDOC_ds_local_documento"), dto.PDOC_ds_local_documento, False, base._strPadrao, 100, True, getAllowedValues("PDOC_ds_local_documento"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "PDOC_ds_rede_documento"), dto.PDOC_ds_rede_documento, False, base._strPadrao, 100, True, getAllowedValues("PDOC_ds_rede_documento"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "PDOC_ds_path_documento"), dto.PDOC_ds_path_documento, False, base._strPadrao, 500, True, getAllowedValues("PDOC_ds_path_documento"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        If mode = tb_PDOC_processo_documento.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_PDOC_processo_documento) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "PDOC")
...
fim:
        Return ret
    End Function
    Public Function SaveData(ByVal dto As DTO.tb_PDOC_processo_documento, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_PDOC_processo_documento.Mode.Insert
                        Return InsertData(dto)
                    Case tb_PDOC_processo_documento.Mode.Update
...
'Case PDOC_nm_documento
 'values = ""

'Case PDOC_ds_documento
 'values = ""

'Case PDOC_ds_local_documento
 'values = ""

'Case PDOC_ds_rede_documento
 'values = ""

'Case PDOC_ds_path_documento
 'values = ""
