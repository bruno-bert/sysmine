Public Class tb_UNME_unidade_medida
    ...
    Private _UNME_nm_unidade As Object
Private _UNME_ds_unidade As Object
Private _UNME_nm_tipo As Object
...
Private _AUDT_nm_usuario_alteracao As Object
    ...
    End Property
      ...
      Public Property UNME_nm_unidade() As Object
        Get
            Return _UNME_nm_unidade
        End Get
        Set(ByVal value As Object)
            _UNME_nm_unidade = value
        End Set
    End Property

  Public Property UNME_ds_unidade() As Object
        Get
            Return _UNME_ds_unidade
        End Get
        Set(ByVal value As Object)
            _UNME_ds_unidade = value
        End Set
    End Property

  Public Property UNME_nm_tipo() As Object
        Get
            Return _UNME_nm_tipo
        End Get
        Set(ByVal value As Object)
            _UNME_nm_tipo = value
        End Set
