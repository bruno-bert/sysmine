...
Public Class tb_OPER_operador
    ...
    Private pDTO As DTO.tb_OPER_operador

    Public Sub New(ByVal ConnectionString As String, ByVal entity As DTO.tb_OPER_operador)
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_OPER_operador"
            Dim parm(2) As Parametros

            parm(0).Campo = "@OPER_cd_operador"
parm(0).Tipo = SqlDbType.varchar
parm(0).Conteudo = pDTO.OPER_cd_operador

parm(1).Campo = "@OPER_nm_operador"
parm(1).Tipo = SqlDbType.varchar
parm(1).Conteudo = pDTO.OPER_nm_operador

parm(2).Campo = "@OPER_ds_email"
parm(2).Tipo = SqlDbType.varchar
parm(2).Conteudo = pDTO.OPER_ds_email
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function PagingData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_OPER_operador_rel"
...
parm(6).Campo = "@OPER_cd_operador"
parm(6).Tipo = SqlDbType.varchar
parm(6).Conteudo = pDTO.OPER_cd_operador

parm(7).Campo = "@OPER_nm_operador"
parm(7).Tipo = SqlDbType.varchar
parm(7).Conteudo = pDTO.OPER_nm_operador

parm(8).Campo = "@OPER_ds_email"
parm(8).Tipo = SqlDbType.varchar
parm(8).Conteudo = pDTO.OPER_ds_email
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function UpdateData() As Integer
        Try
            ...
            Dim procName As String = "sp_upd_tb_OPER_operador"
            Dim parm(8) As Parametros
...
parm(3).Campo = "@OPER_fl_alerta"
parm(3).Tipo = SqlDbType.char
parm(3).Conteudo = pDTO.OPER_fl_alerta

parm(4).Campo = "@OPER_fl_alerta_nativo"
parm(4).Tipo = SqlDbType.char
parm(4).Conteudo = pDTO.OPER_fl_alerta_nativo
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, True)> _
   Public Function InsertData() As Integer
        Try
            ...
            Dim procName As String = "sp_ins_tb_OPER_operador"
            Dim parm(8) As Parametros
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, True)> _
   Public Function DeleteData() As Integer
        Try
            ...
            Dim procName As String = "sp_del_tb_OPER_operador"
            Dim parm(2) As Parametros
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ConsultData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_OPER_operador_cons"
