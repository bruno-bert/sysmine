...
Public Class tb_SUBS_substancia
    ...
    Private pDTO As DTO.tb_SUBS_substancia

    Public Sub New(ByVal ConnectionString As String, ByVal entity As DTO.tb_SUBS_substancia)
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_SUBS_substancia"
            Dim parm(0) As Parametros

            parm(0).Campo = "@SUBS_nm_substancia"
parm(0).Tipo = SqlDbType.varchar
parm(0).Conteudo = pDTO.SUBS_nm_substancia
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function PagingData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_SUBS_substancia_rel"
...
parm(6).Campo = "@SUBS_nm_substancia"
parm(6).Tipo = SqlDbType.varchar
parm(6).Conteudo = pDTO.SUBS_nm_substancia
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function UpdateData() As Integer
        Try
            ...
            Dim procName As String = "sp_upd_tb_SUBS_substancia"
            Dim parm(4) As Parametros

            parm(0).Campo = "@SUBS_nm_substancia"
parm(0).Tipo = SqlDbType.varchar
parm(0).Conteudo = pDTO.SUBS_nm_substancia

parm(1).Campo = "@AUDT_dt_inclusao"
parm(1).Tipo = SqlDbType.datetime
parm(1).Conteudo = pDTO.AUDT_dt_inclusao

parm(2).Campo = "@AUDT_nm_usuario_inclusao"
parm(2).Tipo = SqlDbType.varchar
parm(2).Conteudo = pDTO.AUDT_nm_usuario_inclusao

parm(3).Campo = "@AUDT_dt_alteracao"
parm(3).Tipo = SqlDbType.datetime
parm(3).Conteudo = pDTO.AUDT_dt_alteracao

parm(4).Campo = "@AUDT_nm_usuario_alteracao"
parm(4).Tipo = SqlDbType.varchar
parm(4).Conteudo = pDTO.AUDT_nm_usuario_alteracao
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, True)> _
   Public Function InsertData() As Integer
        Try
            ...
            Dim procName As String = "sp_ins_tb_SUBS_substancia"
            Dim parm(4) As Parametros
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, True)> _
   Public Function DeleteData() As Integer
        Try
            ...
            Dim procName As String = "sp_del_tb_SUBS_substancia"
            Dim parm(0) As Parametros
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ConsultData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_SUBS_substancia_cons"
