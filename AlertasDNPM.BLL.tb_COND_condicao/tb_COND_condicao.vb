Public Class tb_COND_condicao
    ...
    Public Function InsertData(ByVal dto As DTO.tb_COND_condicao) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_COND_condicao(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_COND_condicao) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_COND_condicao) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_COND_condicao) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_COND_condicao) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_COND_condicao) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_COND_condicao, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "COND")

        ret = obj.ValidateString(fields.getValue(dt, "COND_nm_condicao"), dto.COND_nm_condicao, False, base._strPadrao, 500, True, getAllowedValues("COND_nm_condicao"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        If mode = tb_COND_condicao.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_COND_condicao) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "COND")
...
fim:
    ...
    Public Function SaveData(ByVal dto As DTO.tb_COND_condicao, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_COND_condicao.Mode.Insert
                        Return InsertData(dto)
                    Case tb_COND_condicao.Mode.Update
