Public Class tb_SINF_situacao_info
    ...
    Public Function InsertData(ByVal dto As DTO.tb_SINF_situacao_info) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_SINF_situacao_info(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_SINF_situacao_info) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_SINF_situacao_info) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_SINF_situacao_info) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_SINF_situacao_info) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_SINF_situacao_info) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_SINF_situacao_info, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "SINF")
        ...
        ret = obj.ValidateString(fields.getValue(dt, "SINF_ds_situacao_info"), dto.SINF_ds_situacao_info, False, base._strPadrao, 100, True, getAllowedValues("SINF_ds_situacao_info"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        If mode = tb_SINF_situacao_info.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_SINF_situacao_info) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "SINF")
...
fim:
        Return ret
    End Function
    Public Function SaveData(ByVal dto As DTO.tb_SINF_situacao_info, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_SINF_situacao_info.Mode.Insert
                        Return InsertData(dto)
                    Case tb_SINF_situacao_info.Mode.Update
