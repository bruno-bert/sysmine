...
Public Class tb_COVE_controle_vencimento
    ...
    Private pDTO As DTO.tb_COVE_controle_vencimento

    Public Sub New(ByVal ConnectionString As String, ByVal entity As DTO.tb_COVE_controle_vencimento)
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_COVE_controle_vencimento"
...
parm(2).Campo = "@COVE_nm_tipo_documento"
parm(2).Tipo = SqlDbType.varchar
parm(2).Conteudo = pDTO.COVE_nm_tipo_documento

parm(3).Campo = "@COVE_id_documento"
parm(3).Tipo = SqlDbType.varchar
parm(3).Conteudo = pDTO.COVE_id_documento
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function PagingData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_COVE_controle_vencimento_rel"
...
parm(8).Campo = "@COVE_nm_tipo_documento"
parm(8).Tipo = SqlDbType.varchar
parm(8).Conteudo = pDTO.COVE_nm_tipo_documento

parm(9).Campo = "@COVE_id_documento"
parm(9).Tipo = SqlDbType.varchar
parm(9).Conteudo = pDTO.COVE_id_documento

parm(10).Campo = "@COVE_qt_inicio"
parm(10).Tipo = SqlDbType.int
parm(10).Conteudo = pDTO.COVE_qt_inicio

parm(11).Campo = "@COVE_qt_intervalo"
parm(11).Tipo = SqlDbType.int
parm(11).Conteudo = pDTO.COVE_qt_intervalo
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function UpdateData() As Integer
        Try
            ...
            Dim procName As String = "sp_upd_tb_COVE_controle_vencimento"
...
parm(4).Campo = "@COVE_qt_inicio"
parm(4).Tipo = SqlDbType.int
parm(4).Conteudo = pDTO.COVE_qt_inicio

parm(5).Campo = "@COVE_qt_intervalo"
parm(5).Tipo = SqlDbType.int
parm(5).Conteudo = pDTO.COVE_qt_intervalo
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, True)> _
   Public Function InsertData() As Integer
        Try
            ...
            Dim procName As String = "sp_ins_tb_COVE_controle_vencimento"
            Dim parm(9) As Parametros
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, True)> _
   Public Function DeleteData() As Integer
        Try
            ...
            Dim procName As String = "sp_del_tb_COVE_controle_vencimento"
            Dim parm(3) As Parametros
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ConsultData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_COVE_controle_vencimento_cons"
