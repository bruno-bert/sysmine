Public Class tb_MPRI_mprima
   ...
   Public Function GetNextIndex(ByVal dto As DTO.tb_MPRI_mprima, field as String) As Long
        ...
        Dim dal As New DAL.tb_MPRI_mprima(ConnectionString, dto)
    ...
    Public Function InsertData(ByVal dto As DTO.tb_MPRI_mprima) As Boolean
    ...
    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_MPRI_mprima) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_MPRI_mprima) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_MPRI_mprima) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_MPRI_mprima) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_MPRI_mprima) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_MPRI_mprima, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "MPRI")
...
If mode = tb_MPRI_mprima.Mode.Insert Then 
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function customValidation(ByVal dto As DTO.tb_MPRI_mprima) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "MPRI")
    ...
    Public Function SaveData(ByVal dto As DTO.tb_MPRI_mprima, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
             Select Case mode
                Case tb_MPRI_mprima.Mode.Insert
                    Return InsertData(dto)
                Case tb_MPRI_mprima.Mode.Update
