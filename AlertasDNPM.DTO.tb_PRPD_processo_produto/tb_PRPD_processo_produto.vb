...
Private _MPRI_nm_mprima As Object
Private _PROD_nm_produto As Object
Private _PRPD_vl_produto As Object
Private _PRPD_un_produto As Object
Private _UPRD_nm_uso As Object
...
Private _AUDT_nm_usuario_alteracao As Object
  ...
  Public Property MPRI_nm_mprima() As Object
        Get
            Return _MPRI_nm_mprima
        End Get
        Set(ByVal value As Object)
            _MPRI_nm_mprima = value
        End Set
    End Property

  Public Property PROD_nm_produto() As Object
        Get
            Return _PROD_nm_produto
        End Get
        Set(ByVal value As Object)
            _PROD_nm_produto = value
        End Set
    End Property

  Public Property PRPD_vl_produto() As Object
        Get
            Return _PRPD_vl_produto
        End Get
        Set(ByVal value As Object)
            _PRPD_vl_produto = value
        End Set
    End Property

  Public Property PRPD_un_produto() As Object
        Get
            Return _PRPD_un_produto
        End Get
        Set(ByVal value As Object)
            _PRPD_un_produto = value
        End Set
    End Property

  Public Property UPRD_nm_uso() As Object
        Get
            Return _UPRD_nm_uso
        End Get
        Set(ByVal value As Object)
