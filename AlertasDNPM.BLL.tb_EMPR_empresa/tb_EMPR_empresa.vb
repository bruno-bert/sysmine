Public Class tb_EMPR_empresa
    ...
    Public Function InsertData(ByVal dto As DTO.tb_EMPR_empresa) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_EMPR_empresa(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_EMPR_empresa) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_EMPR_empresa) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_EMPR_empresa) As DataTable
    ...
    End Function
    Public Function GetDataDistinct(ByVal dto As DTO.tb_EMPR_empresa) As DataTable
        ...
        Dim dal As New DAL.tb_EMPR_empresa(ConnectionString, dto)
        Return dal.GetDataDistinct()

    End Function
    Public Function ConsultData(ByVal dto As DTO.tb_EMPR_empresa) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_EMPR_empresa) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_EMPR_empresa, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "EMPR")

        ret = obj.ValidateString(fields.getValue(dt, "EMPR_nm_empresa"), dto.EMPR_nm_empresa, True, 5, 20, True, getAllowedValues("EMPR_nm_empresa"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "EMPR_ds_empresa"), dto.EMPR_ds_empresa, True, 5, 300, True, getAllowedValues("EMPR_ds_empresa"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        ret = obj.ValidateString(fields.getValue(dt, "EMPR_ds_dou"), dto.EMPR_ds_dou, True, 0, 500, False, getAllowedValues("EMPR_ds_dou"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret



        ret = obj.ValidateString(fields.getValue(dt, "EMPR_fl_status"), dto.EMPR_fl_status, False, base._strPadrao, 1, True, getAllowedValues("EMPR_fl_status"), forceInvalidation, addFieldNameToMessage)
        If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

        If mode = tb_EMPR_empresa.Mode.Insert Then
    ...
    End Function
    Public Function customValidation(ByVal dto As DTO.tb_EMPR_empresa) As String
        Dim ret As String = ""
...
fim:
        Return ret
    End Function
    Public Function SaveData(ByVal dto As DTO.tb_EMPR_empresa, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
                Select Case mode
                    Case tb_EMPR_empresa.Mode.Insert
                        Return InsertData(dto)
                    Case tb_EMPR_empresa.Mode.Update
    ...
    Private Function getAllowedValues(field as String) as String
     ...
     'select case field
      'Case EMPR_nm_empresa
 'values = ""

'Case EMPR_ds_empresa
 'values = ""
