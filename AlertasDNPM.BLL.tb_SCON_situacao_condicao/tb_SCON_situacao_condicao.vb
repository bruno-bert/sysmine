Public Class tb_SCON_situacao_condicao
   ...
   Public Function GetNextIndex(ByVal dto As DTO.tb_SCON_situacao_condicao, field as String) As Long
        ...
        Dim dal As New DAL.tb_SCON_situacao_condicao(ConnectionString, dto)
    ...
    Public Function InsertData(ByVal dto As DTO.tb_SCON_situacao_condicao) As Boolean
    ...
    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_SCON_situacao_condicao) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_SCON_situacao_condicao) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_SCON_situacao_condicao) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_SCON_situacao_condicao) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_SCON_situacao_condicao) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_SCON_situacao_condicao, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "SCON")
...
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.SCON_ds_situacao_condicao, False, base._strPadrao, 100, True, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

If mode = tb_SCON_situacao_condicao.Mode.Insert Then 
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function customValidation(ByVal dto As DTO.tb_SCON_situacao_condicao) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "SCON")
    ...
    Public Function SaveData(ByVal dto As DTO.tb_SCON_situacao_condicao, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
             Select Case mode
                Case tb_SCON_situacao_condicao.Mode.Insert
                    Return InsertData(dto)
                Case tb_SCON_situacao_condicao.Mode.Update
