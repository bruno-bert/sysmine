Public Class tb_PORG_processo_orgao
   ...
   Public Function GetNextIndex(ByVal dto As DTO.tb_PORG_processo_orgao, field as String) As Long
        ...
        Dim dal As New DAL.tb_PORG_processo_orgao(ConnectionString, dto)
    ...
    Public Function InsertData(ByVal dto As DTO.tb_PORG_processo_orgao) As Boolean
    ...
    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_PORG_processo_orgao) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_PORG_processo_orgao) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_PORG_processo_orgao) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_PORG_processo_orgao) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_PORG_processo_orgao) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_PORG_processo_orgao, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "PORG")
...
FieldName = "PORG_nm_cadastro"
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.PORG_nm_cadastro, False, base._strPadrao, 30, False, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

FieldName = "PORG_ds_atividade"
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.PORG_ds_atividade, False, base._strPadrao, 500, False, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

If mode = tb_PORG_processo_orgao.Mode.Insert Then 
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function customValidation(ByVal dto As DTO.tb_PORG_processo_orgao) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "PORG")
    ...
    Public Function SaveData(ByVal dto As DTO.tb_PORG_processo_orgao, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
             Select Case mode
                Case tb_PORG_processo_orgao.Mode.Insert
                    Return InsertData(dto)
                Case tb_PORG_processo_orgao.Mode.Update
...
'Case PORG_nm_cadastro
 'values = ""

'Case PORG_ds_atividade
 'values = ""
