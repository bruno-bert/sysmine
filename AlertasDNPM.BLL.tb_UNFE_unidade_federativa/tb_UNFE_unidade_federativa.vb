Public Class tb_UNFE_unidade_federativa
    ...
    Public Function InsertData(ByVal dto As DTO.tb_UNFE_unidade_federativa) As Boolean

        If _connectionString.Trim.Length = 0 Then
           Throw New Exception("String de Conexao com Banco de Dados nao foi informada")
        End If

        Dim dal As New DAL.tb_UNFE_unidade_federativa(ConnectionString, dto)
        Return dal.InsertData() > 0

    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_UNFE_unidade_federativa) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_UNFE_unidade_federativa) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_UNFE_unidade_federativa) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_UNFE_unidade_federativa) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_UNFE_unidade_federativa) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_UNFE_unidade_federativa, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "UNFE")

        ret = obj.ValidateString(fields.getValue(dt, "UNFE_cd_unidade_federativa"), dto.UNFE_cd_unidade_federativa, False, base._strPadrao, 2, True, getAllowedValues("UNFE_cd_unidade_federativa"))
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

ret = obj.ValidateString(fields.getValue(dt, "UNFE_nm_unidade_federativa"), dto.UNFE_nm_unidade_federativa, False, base._strPadrao, 100, True, getAllowedValues("UNFE_nm_unidade_federativa"))
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

ret = obj.ValidateString(fields.getValue(dt, "UNFE_fl_status"), dto.UNFE_fl_status, False, base._strPadrao, 1, True, getAllowedValues("UNFE_fl_status"))
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function SaveData(ByVal dto As DTO.tb_UNFE_unidade_federativa, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
        ...
        If boolValidate Then
            ...
            Select Case mode
                Case tb_UNFE_unidade_federativa.Mode.Insert
                    Return InsertData(dto)
                Case tb_UNFE_unidade_federativa.Mode.Update
...
'Case UNFE_nm_unidade_federativa
 'values = ""
