Public Class tb_UNME_unidade_medida
   ...
   Public Function GetNextIndex(ByVal dto As DTO.tb_UNME_unidade_medida, field as String) As Long
        ...
        Dim dal As New DAL.tb_UNME_unidade_medida(ConnectionString, dto)
    ...
    Public Function InsertData(ByVal dto As DTO.tb_UNME_unidade_medida) As Boolean
    ...
    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_UNME_unidade_medida) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_UNME_unidade_medida) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_UNME_unidade_medida) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_UNME_unidade_medida) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_UNME_unidade_medida) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_UNME_unidade_medida, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "UNME")

        FieldName = "UNME_nm_unidade"
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.UNME_nm_unidade, False, base._strPadrao, 10, True, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

FieldName = "UNME_ds_unidade"
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.UNME_ds_unidade, False, base._strPadrao, 100, True, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

FieldName = "UNME_nm_tipo"
ret = obj.ValidateString(fields.getValue(dt, FieldName), dto.UNME_nm_tipo, False, base._strPadrao, 2, True, getAllowedValues(FieldName), forceInvalidation, addFieldNameToMessage)
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret

If mode = tb_UNME_unidade_medida.Mode.Insert Then 
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function customValidation(ByVal dto As DTO.tb_UNME_unidade_medida) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "UNME")
    ...
    Public Function SaveData(ByVal dto As DTO.tb_UNME_unidade_medida, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
             Select Case mode
                Case tb_UNME_unidade_medida.Mode.Insert
                    Return InsertData(dto)
                Case tb_UNME_unidade_medida.Mode.Update
    ...
    Private Function getAllowedValues(field as String) as String
     ...
     'select case field
      'Case UNME_nm_unidade
 'values = ""

'Case UNME_ds_unidade
 'values = ""
