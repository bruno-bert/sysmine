Public Class tb_PROD_produto
   ...
   Public Function GetNextIndex(ByVal dto As DTO.tb_PROD_produto, field as String) As Long
        ...
        Dim dal As New DAL.tb_PROD_produto(ConnectionString, dto)
    ...
    Public Function InsertData(ByVal dto As DTO.tb_PROD_produto) As Boolean
    ...
    End Function
    Public Function UpdateData(ByVal dto As DTO.tb_PROD_produto) As String
    ...
    End Function
    Public Function DeleteData(ByVal dto As DTO.tb_PROD_produto) As String
    ...
    End Function
    Public Function GetData(ByVal dto As DTO.tb_PROD_produto) As DataTable
    ...
    Public Function ConsultData(ByVal dto As DTO.tb_PROD_produto) As DataTable
    ...
    Public Function PagingData(ByVal dto As DTO.tb_PROD_produto) As DataTable
    ...
    Public Function Validate(ByVal dto As DTO.tb_PROD_produto, _
        ...
        Dim dt As DataTable = fields.getFormData(_xmlPath, "PROD")
...
If mode = tb_PROD_produto.Mode.Insert Then 
...
If ret.Trim.Length > 0 Then log = log & IIf(log.Trim.Length > 0, base._chrPulaLinhaGen, "") & ret
    ...
    Public Function customValidation(ByVal dto As DTO.tb_PROD_produto) As String
        Dim ret As String = ""
        Dim val As New Apoio.Validation
        Dim obj As New Apoio.Globalization
        Dim dt As DataTable = obj.getData(_xmlPath, "customvalidate")
        'Dim dtFields As DataTable = obj.getFormData(_xmlPath, "PROD")
    ...
    Public Function SaveData(ByVal dto As DTO.tb_PROD_produto, _
                             ByRef message As String, _
                             ByRef action As ValidationReturnType, _
                             ByVal mode As Mode, _
        ...
        If boolValidate Then
            ...
            Try
             Select Case mode
                Case tb_PROD_produto.Mode.Insert
                    Return InsertData(dto)
                Case tb_PROD_produto.Mode.Update
