...
Public Class tb_PRSD_processo_sd
    ...
    Private pDTO As DTO.tb_PRSD_processo_sd

    Public Sub New(ByVal ConnectionString As String, ByVal entity As DTO.tb_PRSD_processo_sd)
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_PRSD_processo_sd"
...
parm(2).Campo = "@PRSD_nm_sd"
parm(2).Tipo = SqlDbType.varchar
parm(2).Conteudo = pDTO.PRSD_nm_sd
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function PagingData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_PRSD_processo_sd_rel"
...
parm(8).Campo = "@PRSD_nm_sd"
parm(8).Tipo = SqlDbType.varchar
parm(8).Conteudo = pDTO.PRSD_nm_sd

parm(9).Campo = "@PRSD_dt_sd"
parm(9).Tipo = SqlDbType.datetime
parm(9).Conteudo = pDTO.PRSD_dt_sd

parm(10).Campo = "@PRSD_nm_prc"
parm(10).Tipo = SqlDbType.varchar
parm(10).Conteudo = pDTO.PRSD_nm_prc

parm(11).Campo = "@PRSD_nm_doc"
parm(11).Tipo = SqlDbType.varchar
parm(11).Conteudo = pDTO.PRSD_nm_doc

parm(12).Campo = "@PRSD_dt_ini"
parm(12).Tipo = SqlDbType.datetime
parm(12).Conteudo = pDTO.PRSD_dt_ini

parm(13).Campo = "@SISD_nm_situacao_sd"
parm(13).Tipo = SqlDbType.varchar
parm(13).Conteudo = pDTO.SISD_nm_situacao_sd

parm(14).Campo = "@OSSD_nm_objeto"
parm(14).Tipo = SqlDbType.varchar
parm(14).Conteudo = pDTO.OSSD_nm_objeto
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function UpdateData() As Integer
        Try
            ...
            Dim procName As String = "sp_upd_tb_PRSD_processo_sd"
...
parm(3).Campo = "@PRSD_dt_sd"
parm(3).Tipo = SqlDbType.datetime
parm(3).Conteudo = pDTO.PRSD_dt_sd

parm(4).Campo = "@PRSD_nm_prc"
parm(4).Tipo = SqlDbType.varchar
parm(4).Conteudo = pDTO.PRSD_nm_prc

parm(5).Campo = "@PRSD_nm_doc"
parm(5).Tipo = SqlDbType.varchar
parm(5).Conteudo = pDTO.PRSD_nm_doc

parm(6).Campo = "@PRSD_dt_ini"
parm(6).Tipo = SqlDbType.datetime
parm(6).Conteudo = pDTO.PRSD_dt_ini

parm(7).Campo = "@SISD_nm_situacao_sd"
parm(7).Tipo = SqlDbType.varchar
parm(7).Conteudo = pDTO.SISD_nm_situacao_sd

parm(8).Campo = "@OSSD_nm_objeto"
parm(8).Tipo = SqlDbType.varchar
parm(8).Conteudo = pDTO.OSSD_nm_objeto
...
parm(12).Conteudo = pDTO.AUDT_nm_usuario_alteracao
            ...
            parm(13).Campo = "@PRSD_dt_fim"
            parm(13).Tipo = SqlDbType.DateTime
            parm(13).Conteudo = pDTO.PRSD_dt_fim
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, True)> _
   Public Function InsertData() As Integer
        Try
            ...
            Dim procName As String = "sp_ins_tb_PRSD_processo_sd"
            Dim parm(13) As Parametros
...
<System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, True)> _
   Public Function DeleteData() As Integer
        Try
            ...
            Dim procName As String = "sp_del_tb_PRSD_processo_sd"
            Dim parm(2) As Parametros
 ...
 <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, False)> _
    Public Function ConsultData() As DataTable
        Try
            ...
            Dim procName As String = "sp_sel_tb_PRSD_processo_sd_cons"
